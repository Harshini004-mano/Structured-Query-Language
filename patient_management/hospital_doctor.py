...
def setup_db():
    """Initial setup: create database and tables if they don't exist."""
    ...
    # ✅ Check if index already exists before creating (MySQL-safe)
    cur.execute("""
    SELECT COUNT(1)
...
def register_patient():
    ...
    cur.execute("""
        INSERT INTO appt (idno, name, age, gender, phone, bg)
        VALUES (%s, %s, %s, %s, %s, %s)
